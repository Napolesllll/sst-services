...
interface InspeccionEslingaModalProps {
  serviceId: string;
  onClose: () => void;
  onSuccess: () => void;
  existingData?: any;
...
export default function InspeccionEslingaModal({
  serviceId,
  onClose,
  onSuccess,
  existingData,
}: InspeccionEslingaModalProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    tipoEslinga: existingData?.tipoEslinga || "",
    longitud: existingData?.longitud || "",
  ...
  const [checkItems, setCheckItems] = useState<CheckItem[]>(
    existingData?.checkItems || [
      {
        id: "etiqueta",
        label: "Etiqueta de identificación legible con datos de fabricante",
        checked: false,
      },
      {
        id: "cable_cuerda",
        label: "Cable o cuerda sin deshilachados, cortes o roturas",
        checked: false,
      },
      {
        id: "costuras",
        label: "Costuras en perfecto estado (si aplica)",
        checked: false,
      },
      {
        id: "mosquetones",
        label: "Mosquetones/ganchos funcionan correctamente",
        checked: false,
      },
      {
        id: "seguros",
        label: "Seguros de mosquetones cierran completamente",
        checked: false,
      },
      {
        id: "desgaste",
        label: "Sin desgaste excesivo o abrasión en puntos críticos",
        checked: false,
      },
      {
        id: "corrosion",
        label: "Elementos metálicos sin corrosión ni deformación",
        checked: false,
      },
      {
        id: "nudos",
        label: "Sin nudos no autorizados",
        checked: false,
      },
      {
        id: "limpieza",
        label: "Eslinga limpia y libre de contaminantes químicos",
        checked: false,
      },
      {
        id: "certificacion",
  ...
  const handleSubmit = async () => {
    if (!formData.marca || !formData.tipoEslinga) {
      setError("Completa la información básica de la eslinga");
      return;
    }
    ...
    if (!allChecked) {
      if (
        !confirm(
          "⚠️ NO todos los ítems están aprobados. Esta eslinga será marcada como NO APTA. ¿Continuar?"
        )
      ) {
        return;
      }
            ...
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-2xl font-bold text-white mb-2 flex items-center gap-2">
                  🔗 Inspección de Eslinga de Seguridad
                </h2>
              ...
              >
                <div className="p-4 bg-cyan-500/10 border border-cyan-500/30 rounded-lg">
                  <p className="text-sm text-cyan-400">
                    ℹ️ Las eslingas son elementos críticos de conexión. Verifica
                    cuidadosamente cada punto de inspección.
                  </p>
                </div>
              ...
              >
                <div className="p-4 bg-yellow-500/10 border border-yellow-500/30 rounded-lg">
                  <p className="text-sm text-yellow-400 font-semibold">
                    ⚠️ Inspección visual detallada - Todos los ítems deben estar
                    ✓
                  </p>
                </div>
              ...
              >
                <div>
                  ...
                  <textarea
                    ...
                    rows={5}
                    placeholder="Observaciones adicionales, hallazgos importantes o recomendaciones..."
                ...
                <div className="p-5 bg-gray-800/50 rounded-lg border border-gray-700">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <p className="text-gray-500">Eslinga</p>
